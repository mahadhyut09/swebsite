...
userApp.post(
  ...
  expressAsyncHandler(async (request, response) => {
    ...
    let userOfDB=await userCollectionObject.findOne({Rollno:userCredObj.Rollno});
...
userApp.post(
  ...
  expressAsyncHandler(async (request, response) => {
    ...
    //if user not existed
      ...
      //insert newUser
      await userCollectionObject.insertOne({Rollno:newUserObj.Rollno,password:newUserObj.password});
      //send response
